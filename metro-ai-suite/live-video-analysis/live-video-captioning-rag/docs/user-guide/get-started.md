...
- OpenVINO-compatible LLM in `llm_models/`. User may refer to the [model preparation steps](../../../live-video-captioning/docs/user-guide/get-started.md) provided to prepare the model.
...
7. **Access the application**:
     ...
     3. To demonstrate the full functionality, run the following commands to create context using a sample image and caption:
         ...
         - Call the `embedding/` endpoint to generate embeddings
