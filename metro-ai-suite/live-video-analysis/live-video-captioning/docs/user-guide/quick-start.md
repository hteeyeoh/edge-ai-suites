...
Get the application up and running in 5–10 minutes.

Live Video Captioning uses AI to automatically describe what is happening in a live video stream — from a camera or an RTSP feed — and displays those descriptions in real time on a web dashboard.
