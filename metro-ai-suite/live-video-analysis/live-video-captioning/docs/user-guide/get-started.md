...
| `ENABLE_EMBEDDING` | `false` | Forwards captions and frame blobs to the RAG embedding service when set to `true`. |
...
For the full list of supported models and RAG/LLM model setup, see [Model Preparation](./get-started/model-preparation.md).
