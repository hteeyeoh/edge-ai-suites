...
export ENABLE_LATENCY_CHECK="${ENABLE_LATENCY_CHECK:-false}"
export ENABLE_LATENCY_FILE_OUTPUT="${ENABLE_LATENCY_FILE_OUTPUT:-false}"
export LATENCY_OUTPUT_FILE="${LATENCY_OUTPUT_FILE:-resources/latency_metrics.jsonl}"
